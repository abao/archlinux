...
-- THEME
--beautiful.init("/home/xie/.config/awesome/themes/jack2/theme.lua")
beautiful.init("/home/xie/.config/awesome/themes/jack2/theme.lua")
...
spacerwidget = widget({ type = "imagebox" })
	spacerwidget.image = image("/home/xie/.config/awesome/themes/jack2/spacer.png")
...
clockwidget = widget({ type = "textbox" })
	...
	function cal_gett()
		local fp = io.popen("remind /home/xie/.reminders")
		local rem = fp:read("*a")
		fp:close()
